            ...
            <div className="content">
              ...
              <div className="letter" ref={letterRef}>
                <div className="body">
                  ...
                  <p className="message ">My Dear sweetheart,
                    <br />
                    I am writing this letter to you to let you know how much you mean to me.
                     I love you more than words can express.
                     You are my soulmate, my best friend, my partner in crime, my everything.
                  </p>
                </div>
              </div>
            </div>
